...
export default function FileBrowserPanel({
  ...
  return (
    ...
    >
      <div
        className="flex h-9 min-h-9 shrink-0 items-center gap-1 border-b border-border bg-background px-2 in-data-[preview-panel-mode=inline]:mb-1 in-data-[preview-panel-mode=inline]:h-9 in-data-[preview-panel-mode=inline]:min-h-9 in-data-[preview-panel-mode=inline]:border-b-transparent"
