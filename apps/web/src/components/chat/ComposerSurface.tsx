    ...
    <div
      ...
      className={cn(
        ...
        contextStrip && [
          ...
          "before:[clip-path:shape(from_0_var(--chat-composer-radius),curve_to_var(--chat-composer-radius)_0_with_0_var(--chat-composer-curve)/var(--chat-composer-curve)_0,line_to_calc(100%-var(--chat-composer-radius))_0,curve_to_100%_var(--chat-composer-radius)_with_calc(100%-var(--chat-composer-curve))_0/100%_var(--chat-composer-curve),line_to_100%_calc(100%-var(--chat-composer-context-extension)-var(--chat-composer-drawer-inset)),curve_to_calc(100%-var(--chat-composer-drawer-inset))_calc(100%-var(--chat-composer-context-extension))_with_100%_calc(100%-var(--chat-composer-context-extension)-var(--chat-composer-drawer-inset)*0.4477)/calc(100%-var(--chat-composer-drawer-inset)*0.4477)_calc(100%-var(--chat-composer-context-extension)),line_to_calc(100%-var(--chat-composer-drawer-inset))_calc(100%-var(--chat-composer-strip-radius)),curve_to_calc(100%-var(--chat-composer-drawer-inset)-var(--chat-composer-strip-radius))_100%_with_calc(100%-var(--chat-composer-drawer-inset))_calc(100%-var(--chat-composer-strip-curve))/calc(100%-var(--chat-composer-drawer-inset)-var(--chat-composer-strip-curve))_100%,line_to_calc(var(--chat-composer-drawer-inset)+var(--chat-composer-strip-radius))_100%,curve_to_var(--chat-composer-drawer-inset)_calc(100%-var(--chat-composer-strip-radius))_with_calc(var(--chat-composer-drawer-inset)+var(--chat-composer-strip-curve))_100%/var(--chat-composer-drawer-inset)_calc(100%-var(--chat-composer-strip-curve)),line_to_var(--chat-composer-drawer-inset)_calc(100%-var(--chat-composer-context-extension)),curve_to_0_calc(100%-var(--chat-composer-context-extension)-var(--chat-composer-drawer-inset))_with_calc(var(--chat-composer-drawer-inset)*0.4477)_calc(100%-var(--chat-composer-context-extension))/0_calc(100%-var(--chat-composer-context-extension)-var(--chat-composer-drawer-inset)*0.4477),line_to_0_var(--chat-composer-radius),close)]",
...
const contextSeamClasses =
  "group-data-with-context/composer-surface:after:[clip-path:polygon(0_0,100%_0,100%_100%,calc(100%-var(--chat-composer-radius))_100%,calc(100%-var(--chat-composer-radius))_calc(100%-2px),var(--chat-composer-radius)_calc(100%-2px),var(--chat-composer-radius)_100%,0_100%)]";
