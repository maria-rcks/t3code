...
export function PreviewChromeRow({
  ...
  return (
    <div className="relative">
      <form
        onSubmit={submit}
        className="flex h-9 min-h-9 shrink-0 items-center gap-1 border-b border-border bg-background px-2 in-data-[preview-panel-mode=inline]:mb-3 in-data-[preview-panel-mode=inline]:h-7 in-data-[preview-panel-mode=inline]:min-h-7 in-data-[preview-panel-mode=inline]:border-b-transparent"
