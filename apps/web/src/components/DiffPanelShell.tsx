...
function getDiffPanelHeaderRowClassName(mode: DiffPanelMode) {
  ...
  return cn(
    ...
    shouldUseDragRegion
      ...
      : "flex h-9 min-h-9 shrink-0 items-center border-b border-border bg-background in-data-[preview-panel-mode=inline]:mb-3 in-data-[preview-panel-mode=inline]:h-7 in-data-[preview-panel-mode=inline]:min-h-7 in-data-[preview-panel-mode=inline]:border-b-transparent",
  );
}
